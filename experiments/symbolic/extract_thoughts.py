...
from utils.config import (
    BASE_GPT2, COCONUT_GPT2, COCONUT_GPT2_U, PAUSE_GPT2, PROSQA_TEST, VQVAE
)
...
def main():
    ...
    output_path = args.output_path or str(
        VQVAE / f"{args.model}/thoughts_{args.model}.pt"
    )
    ...
    for idx, sample in enumerate(data):
        ...
        thoughts = extract_thoughts_single(base_model, input_ids, K, args.device)
