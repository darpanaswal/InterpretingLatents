...
#   TASK=gsm MODEL_FAMILY=llama MODEL=codi SPLIT=both bash args/extract_thoughts.sh)
########################################
...
# TO OVERRIDE, COPY: TASK=gsm MODEL_FAMILY=llama MODEL=codi SPLIT=both bash args/extract_thoughts.sh
